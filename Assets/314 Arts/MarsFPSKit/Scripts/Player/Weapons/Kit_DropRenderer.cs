                    ...
                    if (ws.attachmentSlots[i].availableAttachments[enabledAttachments[i]].GetType() == typeof(Kit_AttachmentInfo))
                    {
                        ...
                        if (attachmentAndSkinSockets[i].socket)
                        {
                            if (prefabsToUse.fpPrefab)
                            {
                                ...
                                {
                                    creation = Instantiate(prefabsToUse.dropPrefabOverride, attachmentAndSkinSockets[i].socket, false);
                                }
                                else
                                {
                                ...
                                {
                                    attachmentVisualBehaviours[p].Selected(null, AttachmentUseCase.Drop);
