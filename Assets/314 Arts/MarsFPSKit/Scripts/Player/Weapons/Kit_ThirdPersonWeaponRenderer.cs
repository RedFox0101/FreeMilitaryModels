                    ...
                    if (ws.attachmentSlots[i].availableAttachments[enabledAttachments[i]].GetType() == typeof(Kit_AttachmentInfo))
                    {
                        ...
                        if (prefabsToUse.fpPrefab)
                        {
                            if (attachmentAndSkinSockets[i].socket)
                            {
                                ...
                                {
                                    creation = Instantiate(prefabsToUse.tpPrefabOverride, attachmentAndSkinSockets[i].socket, false);
                                }
                                else
                                {
                                ...
                                {
                                    attachmentVisualBehaviours[p].Selected(pb, AttachmentUseCase.ThirdPerson);
